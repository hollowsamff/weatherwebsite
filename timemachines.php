...
<body>
	...
	<div class="scrollmenu" style="background-color:#F7F7F7; padding:10px">
		...
		<span id="pressuresign555" style="padding-right:15px; opacity: 0.731232;"></span>
...
<script>
var offsets = document.getElementById('pressuresign555').getBoundingClientRect();
	var top = offsets.top;
	...
	if ($(window).width() > 700){
	 ...
	 $("#convertbutton").css({left: lefts+133, position:'absolute'});
